...
<!-- Mirrored from pxdraft.com/themeforest/weasley/weasley/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Sep 2024 19:47:24 GMT -->
<head>
    <!-- metas -->
    <meta charset="utf-8">
    ...
    <!-- title -->
    <title>Pramod Sharma | Software Developer</title>
    <!-- Favicon -->
        ...
        <nav class="navbar header-nav header-white header-transparent navbar-expand-lg one-page-nav">
            <div class="container">
                ...
                <a class="navbar-brand" href="#">
                    <img src="{{ asset('') }}assets/img/logo.png" title="" alt="" style="width: 350px;height:auto">
                </a>
                <!-- / -->
                <!-- Mobile Toggle -->
    ...
    <footer class="footer white py-2">
        <div class="container">
            <div class="row align-items-center">
                ...
                <p class="m-0">© 2024 Pramod Sharma. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
...
<!-- Mirrored from pxdraft.com/themeforest/weasley/weasley/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Sep 2024 19:47:32 GMT -->
</html>